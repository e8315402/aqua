...
const FileUpload = CreateClass({
  ...
  IEUpload(e) {
    ...
    const handleOnLoad = function () {
      ...
      try {
        self.uploadSuccess(self.IECallback(self.dataType, partIEID));
      }
      catch (e) {
        self.uploadError(e);
      }
        ...
        /*清除输入框的值*/
        const oInput = document.getElementById(`ajax_upload_hidden_input_${self.IETag}${partIEID}`);
  ...
  _multiIEForm() {
    ...
    const _insertIEForm = function (_formArr,i) {
