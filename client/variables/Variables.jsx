...
let course = [
  {
    ...
    teacher_ch: '鄭有進 教授',
    teacher_en: 'Professor Y C Cheng',
  ...
  },
  {
    ...
    teacher_ch: '劉建宏 教授',
    teacher_en: 'Professor Chien-Hung Liu',
...
// //
//
let hwHeader = ['Student ID', 'Name', 'File', 'Score'];
let hw1 = [
  ['105598067', '連又瑩', 'HW1'],
  ['105598067', '張建發', 'HW1'],
  ['105598067', '黃偉宸', 'HW1'],
...
// //
//
let defaultWidth = window.screen.width > 768 ? window.screen.width * 1 / 3 : window.screen.width;
...
// //
//
const thArray = ['#','Name','Due Date','Status','score'];
const tdArray = [
  ['1' , 'Homework 1' , '2017/09/23' , 'v' , '87'] ,
  ['2' , 'Homework 2' , '2017/10/15' , 'x' , '0'] ,
  ['3' , 'Homework 3' , '2017/10/30' , 'v' , '69'] ,
  ['4' , 'PEP' , '2017/11/17' , 'v' , '73'] ,
  ['5' , 'SRS' , '2017/12/02' , 'v-sub' , ''] ,
  ['6' , 'STD' , '2017/12/28' , 'x-sub' , '']
];
